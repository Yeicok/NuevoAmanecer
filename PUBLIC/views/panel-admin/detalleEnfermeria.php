                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <?php foreach($res as $data){?>
                                            <tr>
                                                ...
                                                <td><a class='nav-link' href='/PUBLIC/lib/Word/consultaWord.php?id=<?php echo $data['idNovedad'];?>'><div style="font-size: 20px;" class='sb-nav-link-icons'><i class='fas fa-file-word'></i></div></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                            </tbody>

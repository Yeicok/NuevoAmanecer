                                            ...
                                            <tbody class="tbody">   
                                                ...
                                                foreach($res as $data){?>
                                                        <tr>
                                                            ...
                                                            <td><a class='btn btn-light' target="_blank" href='/APP/controllers/adminController.php?action=DetallePacientes&id=<?php echo $data['idNovedad'];?>'><i class='far fa-eye'></i></a></td>
